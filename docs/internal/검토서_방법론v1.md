# 검토서 — 방법론 v1 근거 (규칙서 첫 판)

- 일자: 2026-09-14
- 요청 LLM 모델: Claude Fable 5.1 (max effort)
- 대응 산출물: [`CLAUDE.md`](../../CLAUDE.md) (저장소 루트)
- 다음 판의 근거: [`docs/internal/검토서_방법론개정.md`](검토서_방법론개정.md) (v2, 2026-09-16)
- 개정: 2026-09-14 (커밋 전) 커밋→push 규칙과 로컬 데이터 위치 규칙 추가. 선행 프로젝트의 저장소명·시스템명을 공개 저장소 규칙(`CLAUDE.md` 12.3절)에 따라 제거

> **이동 이력 (2026-09-17).** 원래 요청 기록 폴더에 있었다. 요청 기록 폴더에는 **사용자 말 원문만** 두기로 정하면서(`CLAUDE.md` 11절) 방법론 근거인 이 문서를 `docs/internal/`의 검토서로 옮겼다. 1절은 사용자 요청 원문이고 2절 이후는 그 요청을 규칙으로 옮긴 판단이라, 성격이 섞인 문서였다. 근거는 [`docs/internal/검토서_방법론개정.md`](검토서_방법론개정.md) 5.3절.
...
- `CLAUDE.md` v1 (2026-09-14, `impl-phase0`). 이후 v2로 개정됐다 — `docs/internal/검토서_방법론개정.md`
