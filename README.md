...
**현재 단계**: Phase 10까지 완료 (사내 LLM 질문, 2026-09-25 — 시스템 관리자가 등록한 사내 LLM에 메뉴에서 묻고, 대화는 기간·개수만큼 남는다). Phase 6에서 실시간 동시 편집·버전 비교·HTML 내보내기·템플릿·멘션 메일이 들어왔고, PDF 내보내기와 Confluence 가져오기는 하지 않기로 닫았다.
